...
export function AuthControls() {
  ...
  if (!authConfigured) {
    return <p className="text-xs text-muted-foreground">Auth unavailable (configure Supabase env)</p>
  }
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 text-xs">
      <span className="rounded border px-2 py-1 text-muted-foreground">{user.email}</span>
